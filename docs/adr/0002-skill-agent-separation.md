...
小規模・低リスクの新機能を「対話は/requirementのヒアリングと仕様承認PRの一括レビューの2箇所だけ」で/release-checkまで完走させるモードを、[autopilot](../../.claude/skills/autopilot/SKILL.md)Skillとして追加した(2026-07、その後の拡張は[下記](#自動運転モードのfix起点拡張2026-07追記)参照)。
