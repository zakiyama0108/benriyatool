...
import ImportanceStars from '../../../app/news-digest/components/ImportanceStars'

// 仕様: specs/news-digest/article-detail/requirements.md#記事本文表示-7、specs/news-digest/article-detail/design.md#コンポーネント設計-ImportanceStars
