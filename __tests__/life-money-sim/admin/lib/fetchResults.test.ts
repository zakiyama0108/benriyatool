...
import { buildFilterParams, fetchResults } from '../../../../app/life-money-sim/admin/lib/fetchResults'
import type { Filter } from '../../../../app/life-money-sim/admin/lib/types'

// 仕様: specs/life-money-sim/admin/requirements.md#絞り込み-1、specs/life-money-sim/admin/requirements.md#絞り込み-2、specs/life-money-sim/admin/requirements.md#テストデータの扱い-1、specs/life-money-sim/admin/requirements.md#テストデータの扱い-2、specs/life-money-sim/admin/requirements.md#表示の初期値・区切り-1
...
// 仕様: specs/life-money-sim/admin/requirements.md#一覧表示-2、specs/life-money-sim/admin/requirements.md#絞り込み-1、specs/life-money-sim/admin/requirements.md#絞り込み-2
