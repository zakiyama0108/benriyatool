...
// 仕様: specs/ikukyu/simulator/requirements.md#出産手当金-2
...
// 仕様: specs/ikukyu/simulator/requirements.md#育児休業給付金・前期67%-2
...
// 仕様: specs/ikukyu/papa-birth-date/requirements.md#産後パパ育休の取得可能日数の決定-1
