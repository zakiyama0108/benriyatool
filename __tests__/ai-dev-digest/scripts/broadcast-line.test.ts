...
import { broadcastArticle } from '../../../scripts/ai-dev-digest/broadcast-line'
import { parseArticle } from '../../../app/ai-dev-digest/lib/articleSchema'
import { buildArticleUrl } from '../../../app/ai-dev-digest/lib/articleUrl'

const FIXTURE_PATH = path.join(process.cwd(), '__tests__/ai-dev-digest/fixtures/articles-valid/2026-08-01.json')
...
// 仕様: specs/ai-dev-digest/line-broadcast/requirements.md#配信タイミング・方式-7、specs/ai-dev-digest/line-broadcast/requirements.md#無料枠と配信失敗時の扱い-4、specs/ai-dev-digest/line-broadcast/requirements.md#無料枠と配信失敗時の扱い-5
...
// 仕様: specs/ai-dev-digest/line-broadcast/requirements.md#配信タイミング・方式-8、specs/ai-dev-digest/line-broadcast/requirements.md#配信タイミング・方式-9
...
// 仕様: specs/ai-dev-digest/line-broadcast/design.md#エラーハンドリング
describe('LINEブロードキャスト送信 - 記事データのパースに失敗した場合は配信を行わない(防御的な検証)', () => {
  it('記事データのパースに失敗した場合、配信を行わず例外が投げられること', async () => {
    const invalidPath = path.join(process.cwd(), '__tests__/ai-dev-digest/fixtures/articles-invalid/2026-08-01.json')
