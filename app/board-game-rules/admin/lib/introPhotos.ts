...
// 仕様: admin/design.md「ゲーム紹介画像を差し替え・削除する処理」手順5)。運営者本人のみ実行できる
// (既存のゲーム編集RLSで担保)
...
// (仕様: admin/design.md「ゲーム紹介画像を差し替え・削除する処理」手順2)。既存分と合わせて
...
// 指定パスを配列から取り除いてUPDATEする(仕様: admin/design.md「ゲーム紹介画像を差し替え・削除する処理」手順3)。
...
// 指定パスを先頭へ移動する=メイン画像に変更する(仕様: admin/design.md「ゲーム紹介画像を差し替え・削除する処理」手順4。
