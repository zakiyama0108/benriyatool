...
import { selectCardTopics } from '../lib/selectCardTopics'
...
// page.tsx(1ページ目)・page/[page]/page.tsx(2ページ目以降)から共通で呼び出す
// (ai-dev-digestのArticleListView.tsxと同じ役割分担)
      ...
      <div className="space-y-3">
        {articles.map((article) => (
          <ArticleCard
            key={article.date}
            date={article.date}
            topics={selectCardTopics(article.topics)}
