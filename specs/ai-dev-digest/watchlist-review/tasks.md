...
- Task 9: 見直し案が追加する新規requirements.md項目のspec-coverage対応(仕様: design.md「見直し案を作成する処理」手順7)(TDD対象外。ヘッドレスClaude Code呼び出しのプロンプト調整のため)
  ...
  - 2026-08第6次改定(Task10)により、スキップ登録は「実装まで完了できなかった場合の例外的な扱い」に位置づけが変わった。通常は新しい判定ロジックの実装まで行う
