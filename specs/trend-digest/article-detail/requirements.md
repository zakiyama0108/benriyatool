...
- [11] 継続度ラベルが「流行前」のトピックは、掲載の基準(半月以上続いていること)を満たしていないことが読者にも分かる表記にする。各ジャンルから必ず1件を掲載する運用のため([content-selection/requirements.md#掲載件数](../content-selection/requirements.md))、基準を満たさない話題も掲載されることがあり、なぜ載っているのかが伝わるようにするため
