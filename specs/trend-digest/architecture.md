...
| 中長期ステータス | 候補の継続日数と強度の推移から機械的に判定する段階(NEW/SHORT_TERM/EMERGING/GROWING/ESTABLISHED/STABLE/DECLINING)。記事に載るのはEMERGING/GROWING/ESTABLISHED/STABLEのみ。[trend-history](trend-history/requirements.md)で定義 |
