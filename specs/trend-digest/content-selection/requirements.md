...
### 掲載済み話題の再掲抑制
- [1] 過去に掲載済みのトピック(同一作品名・同一話題)は、採用基準を満たしていても候補から除外する(根拠: ai-dev-digestの[content-selection/requirements.md#掲載済み記事の再掲抑制](../../ai-dev-digest/content-selection/requirements.md)と同じ考え方。ロングラン作品がランキングに残り続けても、新鮮な話題を優先するため)。判定方法の詳細は設計で詰める【推測】
