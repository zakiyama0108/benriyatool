...
- [3] 生成領域の見直し案では、著作権への配慮と、研究結果を誇張しない制約([content-generation/requirements.md](../content-generation/requirements.md)の機能要件[4][5])を弱める変更を提案しない。そうした要望があった場合は、却下したことと理由をPR本文の表に残す
...
- 見直し案の自動マージ
- 画面表示・付箋・LINE配信の見直し
- 配信曜日・1ジャンル1本という配信量そのものの変更(/consultで検討する重い判断のため)
