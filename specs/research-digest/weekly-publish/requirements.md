...
### 掲載件数の保証
- [1] 候補が見つかったジャンルだけを掲載し、見つからないジャンルは載せない([content-selection/requirements.md#候補が見つからないジャンル](../content-selection/requirements.md))。全10ジャンルで1本も採用できなかった場合に限り、その回の公開をスキップする
