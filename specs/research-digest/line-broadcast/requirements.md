...
## サマリ
毎週月曜の研究発見の記事が公開されたら、既存の「AI駆動開発ニュース」と同じLINE公式アカウントから、友だち全員に新着記事の通知を自動で送る。見出しに「【週刊研究発見】」を付けて他の配信と区別する。本文には、その回の全ジャンル(有効なジャンルの数だけ。現在は最大10本)の見出しと記事ページへのリンクを載せる。trend-digestと同じく、記事ページが本番で開けることを確認してから送る。
