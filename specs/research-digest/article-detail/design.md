...
- 手順:
  ...
  2. 影響度順の場合は、研究があるジャンルを影響度の大きい順に並べ、同じ影響度の中ではジャンル順に並べる。掲載できなかったジャンルは、その後ろにジャンル順で並べる(requirements.md#記事本文の表示-6、requirements.md#並び順の切り替え-8)
